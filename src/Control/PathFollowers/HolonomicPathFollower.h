...
public:
    HolonomicPathFollower(const std::shared_ptr<EctoSwerve> &swerve, const std::shared_ptr<botbusters::Trajectory> &traj,
...
private:
    ...
    void
    updateTelemetry(const TrajectoryState &state, const frc::Vector2d &ffVec, const frc::ChassisSpeeds &out);
