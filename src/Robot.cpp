...
#include "Robots/2023/Characterization/SwerveCharacterizationRobot.h"
#include "Robots/2023/Characterization/WristCharacterizationRobot.h"
#include "Robots/2023/Characterization/TelescopicCharacterizationRobot.h"
#include "Robots/2023/Characterization/JointCharacterizationRobot.h"
#include "Robots/2023/Characterization/SwerveDriveVelCharacterizationRobot.h"
#include "Robots/2023/Tests/SwerveSteerTest.h"
#include "Robots/2023/Tests/Trajectory/TrajectoryTest.h"
#include "Robots/2023/DoosanPumaSMX3100.h"
...
int main() {
    ...
    return frc::StartRobot<DoosanPumaSMX3100>();
    //Each one of the tallies bellow is the amount of times I have had to write
    // "DoosanPumaSMX3100" I can now write that word in about 100wpm, just that word though.
    ///////////////////////////////////////////
}
