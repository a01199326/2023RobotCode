...
struct EctoSwerveConfig {
    ...
    units::meter_t length = 1.0_m;
    units::meter_t width = 1.0_m;
...
public:
    ...
    std::shared_ptr<botbusters::SwerveDriveKinematics<4>> getKinematics() const { return kinematics; }
    ...
    void setMinMaxVisionStdDev(double min, double max) {
        minVisionStdDev = min;
        maxVisionStdDev = max;
    }
...
private:
     ...
     * Kinematics
     */
    std::shared_ptr<botbusters::SwerveDriveKinematics<4>> kinematics;

    static std::shared_ptr<botbusters::SwerveDriveKinematics<4>>
    createKinematics(units::meter_t length, units::meter_t width) {
        ...
        return std::make_shared<botbusters::SwerveDriveKinematics<4>>(frontLeft, frontRight, backLeft, backRight);
    }
...
//	std::unique_ptr<NetworkTablePID> steerPIDNT, wheelPIDNT;
     ...
     * Odometry
     */
    std::unique_ptr<botbusters::SwerveDrivePoseEstimator<4>> estimator;
    ...
    double minVisionStdDev = 1.0;
    double maxVisionStdDev = 2.0;

    double prevVelMag = 0.0;
