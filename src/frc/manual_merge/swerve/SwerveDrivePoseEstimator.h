...
#include "TimeInterpolatableBuffer.h"
 ...
 */
    ...
    public:
        ...
        Pose2d UpdateWithTime(units::second_t currentTime,
                              ...
                              const wpi::array<frc::SwerveModuleState, NumModules> &moduleStates,
                              const wpi::array<frc::SwerveModulePosition, NumModules> &modulePositions) {
            auto dt = m_prevTime >= 0_s ? currentTime - m_prevTime : m_nominalDt;
            m_prevTime = currentTime;

            frc::Pose2d currentPose = GetEstimatedPosition();
            ...
            auto moduleDeltas =
                    wpi::array<SwerveModuleState, NumModules>(wpi::empty_array);
            for (size_t index = 0; index < NumModules; index++) {
                ...
                moduleDeltas[index] = {(currentPosition.distance - lastPosition.distance) / dt,
                                       currentPosition.angle};

                m_previousModulePositions[index].distance = modulePositions[index].distance;
            }

            auto chassisSpeeds = m_kinematics.ToChassisSpeeds(moduleDeltas);
    ...
    private:
        ...
        botbusters::TimeInterpolatableBuffer<Pose2d> m_poseBuffer{1.5_s};
