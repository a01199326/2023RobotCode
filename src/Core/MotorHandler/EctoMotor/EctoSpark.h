...
public:
    ...
    void setAbsolutePositionConversionFactor(double conversionFactor) override;

    void setAbsoluteVelocityConversionFactor(double conversionFactor) override;
    ...
    double getAbsPosition() const override;

    double getAbsVelocity() const override;
	
	void setPotAsClosedLoopSource() override;
	
	void setQuadAsClosedLoopSource() override;

    void setAbsoluteAsClosedLoopSource() override;
	
	void setAnalogSensorOffset(double analogOffset) override;

    void setAbsoluteSensorOffset(double offset) override;
    ...
    void prioritizeAbsUpdateRate() override;
    ...
    void enableContinuousInput(double minVal, double maxVal) override;

    void burnFlash() override{
        sparkBase->BurnFlash();
    }

    bool getSensorErrorFault() override;
...
private:
    ...
    std::unique_ptr<rev::SparkMaxAbsoluteEncoder> absoluteEncoder;
