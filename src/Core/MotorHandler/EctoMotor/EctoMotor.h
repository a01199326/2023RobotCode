...
public:
    ...
    double getMotorEncoderPos() const override;

    double getMotorEncoderVel() const override;
    ...
    virtual void setAbsolutePositionConversionFactor(double conversionFactor) = 0;

    virtual void setAbsoluteVelocityConversionFactor(double conversionFactor) = 0;
	
	virtual void setAnalogSensorOffset(double analogVoltageOffset) = 0;

    virtual void setAbsoluteSensorOffset(double offset) = 0;
    ...
    virtual void prioritizeAbsUpdateRate() = 0;

	virtual void deprioritizeUpdateRate(){};

    virtual void setCANTimeout(int milliseconds){};

    virtual void enableContinuousInput(double minVal, double maxVal) = 0;
    ...
    virtual bool getSensorErrorFault(){
        return false;
    }
...
protected:
    ...
    virtual double getAbsPosition() const = 0;

    virtual double getAbsVelocity() const = 0;
    ...
    virtual void setAbsoluteAsClosedLoopSource() = 0;
